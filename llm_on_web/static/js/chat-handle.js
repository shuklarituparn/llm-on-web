    ...
    websocketGuest.addEventListener('message', (e)=>{
        ...
        if (!messagefromserver.done) {
            if (!llm_container) {
                ...
                llm_container.classList.add('bg-opacity-30', 'mt-2', 'mb-2', 'bg-gray-800', 'text-white', 'font-sans1', 'rounded-lg', 'py-2', 'px-4', 'max-w-sm', 'outline', 'outline-offset-2', 'outline-cyan-500');
